            ...
            <div className="flexz flex-col mt-28 gap-2 px-6 mini-tela:px-40">
                ...
                <div className="flex flex-col xl:flex-row items-center xl:items-start gap-8">
                    ...
                    <div className="flex flex-col items-center justify-between xl:w-112 gap-6 xl:h-145">
                        ...
                        <button onClick={() => {handleAddCart(data, searchParams.id);}} className=" CounterCart flex gap-2 justify-center items-center w-full text-white py-2.5 bg-BrandBlue ">
                            <ShoppingBag className="CounterCart" /> 
                            <p className="CounterCart">ADICIONAR AO CARRINHO</p>
                        </button>
                    </div>
                </div>
            </div>
